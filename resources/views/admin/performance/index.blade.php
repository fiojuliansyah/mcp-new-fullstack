                                    ...
                                    @foreach ($subscription->classrooms as $classroom)
                                        ...
                                        <tr class="odd:bg-[#141414] even:bg-[#171717]">
                                            ...
                                            <td class="p-4 border border-gray-700 text-center">
                                                <a href="{{ route('admin.performances.show', $student->id) }}"
                                                class="inline-flex flex-col items-center">
                                                    <div class="bg-gray-50 hover:bg-gray-200 w-[35px] h-[35px] rounded-full flex items-center justify-center">
                                                        <img src="/admin/assets/icons/eye.svg" alt="View" class="size-5 text-black" />
                                                    </div>
                                                    <span class="text-[#5F5F5F] text-[10px] mt-1">View</span>
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
