                ...
                <table class="min-w-full border border-[#424242] text-sm text-left">
                    <thead class="bg-gray-800 text-gray-200">
                        <tr>
                            ...
                            <th class="p-4 border border-[#424242]">Total Notes & Materials Upload</th>
                        ...
                        @foreach ($grouped as $key => $group)
                            @foreach ($group as $index => $schedule)
                                <tr class="odd:bg-[#141414] even:bg-[#171717]">
                                    ...
                                    {{-- Total replay videos --}}
                                    <td class="p-4 border border-gray-700">
                                        {{ $schedule->materials->flatMap->materialFiles->count() ?? '-' }}
                                    </td>

                                    {{-- Action --}}
                                    <td class="p-4 border border-gray-700">
                                        <a href="{{ route('admin.materials.show', $schedule->id) }}" class="flex flex-col items-center">
