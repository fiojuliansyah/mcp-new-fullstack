    ...
    <div class="space-y-7 flex flex-col">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
            <div class="flex items-center gap-3">
                ...
                <h6 class="text-gray-100 font-[600]">Edit Classroom</h6>
            </div>
        </div>
    </div>

    <div class="space-y-10">
        <form action="{{ route('admin.classrooms.update', $classroom->id) }}" method="POST" class="space-y-10">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-12 gap-10 pt-4">
                ...
                <div class="col-span-12">
                    ...
                    <input type="text" name="name" value="{{ $classroom->name }}" placeholder="Enter classroom name"
                    ...
                    <div class="relative">
                        <select name="user_id"
                            ...
                            @foreach($tutors as $tutor)
                                <option value="{{ $tutor->id }}" {{ $classroom->user_id == $tutor->id ? 'selected' : '' }}>
                                    {{ $tutor->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-span-12 lg:col-span-6">
                    ...
                    <input type="date" name="date" value="{{ $classroom->date }}"
                        class="appearance-none bg-gray-1000 border border-gray-950 text-gray-75 rounded-[14px] w-full px-4 py-3" />
                </div>
                ...
                <div class="col-span-12 lg:col-span-6">
                    ...
                    <input type="time" name="time" value="{{ $classroom->time }}"
                        class="appearance-none bg-gray-1000 border border-gray-950 text-gray-75 rounded-[14px] w-full px-4 py-3" />
                </div>
                ...
                <div class="col-span-12 lg:col-span-6">
                    ...
                    <div class="relative">
                        <select name="status"
                            ...
                            <option value="deactive" {{ $classroom->status == 'deactive' ? 'selected' : '' }}>Deactive</option>
                        </select>
                        <div class="pointer-events-none absolute right-5 top-1/2 transform -translate-y-1/2 text-white">
                            <img src="/frontend/assets/icons/angle-down.svg" alt="Icon">
                        </div>
                ...
                <div class="col-span-12">
                    <button type="submit"
                        ...
                        <span class="text-black text-[16px] font-semibold">Update Classroom</span>
                    </button>
                </div>
            </div>
        </form>
